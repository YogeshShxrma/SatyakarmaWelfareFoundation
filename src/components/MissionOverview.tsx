      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-3">{t("missionOverview.plasticFree")}</h3>
            <p className="text-gray-600 dark:text-gray-300">{t("missionOverview.plasticDesc")}</p>
          </div>
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-3">{t("missionOverview.activeChildren")}</h3>
            <p className="text-gray-600 dark:text-gray-300">{t("missionOverview.activeDesc")}</p>
          </div>
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-3">{t("missionOverview.greenCommunities")}</h3>
            <p className="text-gray-600 dark:text-gray-300">{t("missionOverview.greenDesc")}</p>
          </div>
        </div>
      </div>
    </section>
