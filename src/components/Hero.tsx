    ...
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-sage-50 to-earth-50">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center fade-in" style={{ animationDelay: '0.9s' }}>
          <Link 
            to="/get-involved"
            className="bg-sage-600 text-white px-8 py-3 font-medium hover:bg-sage-700 transition-colors shadow-sm rounded-2xl"
          >
            Volunteer with Us
          </Link>
          <Link 
            to="/get-involved"
            className="border border-sage-600 text-sage-600 px-8 py-3 font-medium hover:bg-sage-50 transition-colors rounded-2xl"
          >
            Join Our Programs
          </Link>
        </div>
