...
const MediaGallery = () => {
  ...
  return <section className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-[32px] bg-green-100">
        ...
        {filteredMedia.length === 0 ? <div className="text-center text-gray-600">No media items found.</div> : <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
