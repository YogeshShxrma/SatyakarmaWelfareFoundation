  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {news.length === 0 ? (
          <div className="text-center text-gray-600">No news updates available.</div>
        ) : (
          <div className="space-y-6">
            {news.map((item) => (
              <article key={item.id} className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
