...
const FloatingVolunteerButton = () => {
  return (
    <Link 
      to="/get-involved"
      className="fixed bottom-6 right-6 bg-green-600 text-white p-4 rounded-full shadow-lg hover:bg-green-700 transition-all duration-300 transform hover:scale-110 z-50 group"
